...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, num_contrib, color, opacity, depth, stencil, feature, shader_color, normal, surface_xyz, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(
                    *args)
        ...
        return num_rendered, num_contrib, color, opacity, depth, stencil, feature, shader_color, normal, surface_xyz, radii
...
class GaussianRasterizationSettings(NamedTuple):
    ...
    debug: bool
    h_shShaderManager_ptr: int
    h_splatShaderManager_ptr: int
    time: float
    dt: float
