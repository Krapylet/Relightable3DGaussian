...
void FORWARD::RunPostProcessShaders(
	...
	float *const __restrict__ out_color,
	float *const __restrict__ out_opacity,
	float *const __restrict__ out_depth,
	float *const __restrict__ stencil_tex,
	float *const out_surface_xyz,
	float * const out_pseudonormal,
	int const S,
	float *const __restrict__ out_features,
	Texture::TextureManager *const d_textureManager,
