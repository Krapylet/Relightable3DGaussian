...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        args = (
            ...
            raster_settings.shaderTextureBundles_ptr,
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, num_contrib, color, opacity, depth, feature, shader_color, normal, surface_xyz, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(
                    *args)
        ...
        return num_rendered, num_contrib, color, opacity, depth, feature, shader_color, normal, surface_xyz, radii
